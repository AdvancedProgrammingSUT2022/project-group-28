...
public enum TechnologyTemplate {
    ...
    CHEMISTRY("Chemistry" ,"chemistry", 900 , new TechnologyTemplate[]{GUNPOWDER}),
    PRINTING_PRESS("Printing Press" ,"printing_press", 650 , new TechnologyTemplate[]{MACHINERY,PHYSICS}),
    ECONOMICS("Economics" ,"economics", 900 , new TechnologyTemplate[]{BANKING,PRINTING_PRESS}),
    FERTILIZER("Fertilizer" ,"fertilizer", 1300 , new TechnologyTemplate[]{CHEMISTRY}),
    MILITARY_SCIENCE("Military Science" ,"military_science", 1300 , new TechnologyTemplate[]{ECONOMICS,CHEMISTRY}),
    SCIENTIFIC_THEORY("Scientific Theory" ,"scientific_theory",  1300, new TechnologyTemplate[]{ACOUSTICS}),
    STEAM_POWER("Steam Power" ,"steam_power", 1680 , new TechnologyTemplate[]{SCIENTIFIC_THEORY,MILITARY_SCIENCE}),
    RAILROAD("Railroad" ,"railroad", 1900 , new TechnologyTemplate[]{STEAM_POWER}),
    METALLURGY("Metallurgy" ,"metallurgy", 900 , new TechnologyTemplate[]{GUNPOWDER}),
    REPLACEABLE_PARTS("Replaceable Parts" ,"replaceable_parts", 1900 , new TechnologyTemplate[]{STEAM_POWER}),
    RIFLING("Rifling" ,"rifling", 1425 , new TechnologyTemplate[]{METALLURGY}),
    BIOLOGY("Biology" ,"biology", 1680 , new TechnologyTemplate[]{ARCHAEOLOGY,SCIENTIFIC_THEORY}),
    DYNAMITE("Dynamite" ,"dynamite", 1900 , new TechnologyTemplate[]{FERTILIZER,RIFLING}),
    COMBUSTION("Combustion" ,"combustion", 2200 , new TechnologyTemplate[]{REPLACEABLE_PARTS,RAILROAD,DYNAMITE}),
    ELECTRICITY("Electricity" ,"electricity", 1900 , new TechnologyTemplate[]{BIOLOGY,STEAM_POWER}),
    RADIO("Radio" ,"radio", 2200 , new TechnologyTemplate[]{ELECTRICITY}),
    TELEGRAPH("Telegraph" ,"telegraph", 2200 , new TechnologyTemplate[]{ELECTRICITY});
